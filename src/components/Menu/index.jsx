      ...
      <Container>
        <div class="box-nav">
          <div id="nav-options" class="side-nav-body">
            ...
            <span id="changeSignature" class="nav-item">
              <span class="sky-icon-line-arrow-swap-horizontal sky_icon"></span>
              <span class="nav-title">Trocar assinatura</span>
            </span>
            <span id="showTermsOfUse" class="nav-item terms">
              <span class="sky_icon"></span>
              <span class="nav-title">Termos de Uso</span>
            </span>
            <span id="logOff" class="nav-item">
              <span class="sky-icon-line-exit sky_icon"></span>
              <span class="nav-title">Deslogar</span>
            </span>
          </div>
